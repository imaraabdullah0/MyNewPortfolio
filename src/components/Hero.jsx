    ...
    <div className='w-full h-screen border-t-indigo-300 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                <p className='text-gray-400 text-2xl'>Unique Sequencing & Production</p>
                <h1 className='text-4xl text-blue-500 font-bold py-3 md:text-7xl font-mono '>WEB DEVELOPMENT</h1>
                <p className='text-gray-500 font-extralight'>THIS IS OUR TECH BRAND</p>
                <button className='drop-shadow-lg px-1 py-1 bg-orange-200 rounded hover:-translate-y-1 hover:bg-yellow-100 hover:text-zinc-400 px-8 py-3 text-lg font-bold text-gray-500'>GET STARTED</button>
            </div>
            <div>
                <img className='w-full opacity-70 h-full' src={backGround2} rel='/'/>
            </div>
            <div className='apsolute ml-[10px] mb-[10px] mr-[10px]  flex flex-col py-8 md:min-w-[760px] botton-[-5%] lx-1 md:left-0.5 transform md:translate-x-0.5 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl '>
